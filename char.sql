...
('Professor',
        'Nigel',
        'Montgomery',
        'A history professor at Oxbridge University',
        'nan',
...
Find the cannibal murderer AND stop the Imperium Ritual! It’s going to be a long night...',
        'The late Count Veron Von Lucan - He seemed a nice chap - he did offer you a room when you came knocking at his door with your bogus cover story. To the best of your knowledge he never suspected your real identity.
...
If you are stuck, your Other People section for people of interest.',
...
Dr Josephine Murray - As mentioned, you just want to live in peace. Dr Murray knows you are a vampire and has access to plenty of blood. She regularly supplies you with as much as you need. Your stash is running low at the moment... ',
        'Speak with the DETECTIVE and let him know you’re on side for solving the murder.
...
KELLY was also the first on the scene of the crime - if you are going to figure out  who did this (and why), make sure to ask if she saw or found anything there.',
        'You are a vampire - in fact you are the King of the Vampires in Dunkeldorf.',
...
('Doctor',
        'Josephine',
        'Murray',
        'The late Count’s doctor',
        'nan',
        'You are an excellent doctor, but your interest in anatomy goes beyond the professional and into the “gastronomical.” Yes, you are a CANNIBAL.
...
To top it all off, you STILL haven’t eaten, and the catering this evening isn’t what you’re craving... ',
        'The late Count Veron Von Lucan - The count was 6 months overdue on his medical bills. He was in trouble financially and couldn’t pay, which didn’t leave you too enamoured with him.
...
Genevieve LeClerc - Genevieve approached you the day she arrived in town.  She was a spy by during the Great War, and knows the value of having friends  with access to sensitive information. Though you haven’t known each other very  long, it seems you’ve become friends. You haven’t told her your darkest secret,  but you get the impression you are both like-minded, ambitious people, and you  feel as if you can trust her if you are ever in a pinch.',
        'You are sure that JOSEPH SHAW is Veron Von Lucan - this could be a valuable piece of info that others might buy for the right price.  You have no idea if he saw you fleeing as he awoke in the woods - maybe strike up a conversation, but don’t give too much away.
...
The ring you picked up must be worth a pretty penny - scope out potential buyers but make sure you have a decent story to cover up your grave looting.',
        'You are a cannibal!',
        'You know for a fact Veron von Lucan is alive. He was brought back to life by the magical Lovers’ Ring.',
...
('Aunt',
        'Chastity',
        'Von Lucan',
        'The late Count’s great Aunt, a long-time resident of the castle',
        'nan',
        'But you’re not Great Aunt Chastity, are you? You are Great, Great, Great, Great, Great Aunt Chastity! You’ve kept a close eye on the family and the castle since 1632, because, well, you can’t die. 
...
You need that ring back! Without it, you’re a goner to the next werewolf or bout of pneumonia that comes around. Oh dear, is that a cough coming on?',
        'The late Count Veron Von Lucan - He was an alright nephew - of course he didn’t take as much of your advice as you would have liked, and you were livid to learn he has squandered much of the family fortune and put the ownership of the estate at risk.
...
Joseph Shaw the Groundskeeper - Veron never told you he hired a groundskeeper, otherwise why would you have put the bloody ad in the paper?  Of course it is possible it just slipped Veron’s mind, but you still think it’s suspicious that this Shaw fellow turned up so soon after the Count’s death. Maybe  he’s after the money (what’s left of it), or the estate? You’ve seen your share of  creatures and their lackeys try to take this land, so you are on your guard',
        'Since you suspect those staying in the house to have taken the ring, it might be good to start by speaking to them. Of course don’t limit yourself - it could be anywhere by now if someone has sold or lost it.

The castle deed is probably in high demand, there are most likely other people who want it.

You are worried about your health - it might be worthwhile to speak to DR MURRAY when you have a moment. ',
        'You are 300 years old thanks to the power of the Lovers’ Ring - which renders the wearer immortal. ',
...
('Ms',
        ...
        'nan',
        'nan',
        'As if being an elegant Frenchwoman who engages in casual espionage doesn’t make you interesting enough, you also happen to be a powerful and practised WITCH.
...
Camille Simmons - She is your familiar, under cover as your personal assistant.  She is magically compelled to help you complete the Imperium Ritual, so you  know you can trust her to work with you. ',
        'Pay close attention to the reading of the Count’s will. You have a feeling some of things you need for your ritual might be bequeathed to other people tonight. 
...
IMPORTANT NOTE: Although you do possess magic, you are classified as a  HUMAN (not a supernatural). This will be an important distinction to make  throughout the game.  ',
        'You are a witch who is attempting to complete the Imperium Ritual. ',
...
('Detective',
        'Samuel',
        'Ellacott',
        'The lead investigator in the case of the Count’s death',
        'nan',
        'None',
        'nan',
        'nan',
